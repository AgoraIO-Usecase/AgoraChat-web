...
import { Box, ListItemAvatar, Avatar, ListItem, List, InputBase, Button } from '@material-ui/core';
...
function CombineDialog(props) {
    ...
    function renderGroup() {
        return <Box style={{ display: activeTable == 'contact' ? 'none' : 'block' }}>
        ...
        return (
            <div className={classes.root}>
                <ul className={classes.navigation}>
                    <li className={activeTable == 'contact' ? classes.navigationActive : null} onClick={changeTab('contact')}>联系人</li>
                    <li className={activeTable == 'group' ? classes.navigationActive : null} onClick={changeTab('group')}>群组</li>
                </ul>
                {renderGroup()}
