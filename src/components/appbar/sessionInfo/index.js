      ...
      return (
        <div className={classes.contentBox}>
          {notifyText === 5 ? (
            ...
            <span className={classes.contentStyle}>
              You have muted this Contact until{" "}
              <span className={classes.unmuteTimeStyle}>{unmuteTimeText}</span>.
            </span>
          )}
        </div>
      );
    ...
    if (notifyDialogText === "Mute this Contact") {
      return (
        <div className={classes.btnCenterBox}>
          <div className={classes.btnDoneStyle} onClick={() => handlerOkay(0)}>
            {i18next.t("Done")}
          </div>
        </div>
      );
      ...
      return (
        <div className={classes.btnBox}>
          <span
            className={classes.turnOffBtnStyle}
            onClick={handleTurnOffClose}
          >
            {i18next.t("Cancel")}
          </span>
          <span className={classes.rightBtn} onClick={() => handlerOkay(1)}>
            {i18next.t("Okay")}
          </span>
        </div>
      );
    ...
    <>
      ...
      >
        <Box className={classes.root}>
          ...
          >
            {muteDataObj[to] ? (
              <img src={unmuteIcon} alt="chat" style={{ width: "30px" }} />
            ) : (
              <img src={muteIcon} alt="chat" style={{ width: "30px" }} />
            )}
            <Typography className={classes.infoBtnText}>
              <div>{i18next.t(notifyDialogText)}</div>
              <span className={classes.timeMuteStyle}>
                {i18next.t(muteTimeText)}
              </span>
            </Typography>
          </Button>
          <Button
          ...
          >
            <img src={deleteIcon} alt="new chat" style={{ width: "30px" }} />
            <Typography className={classes.infoBtnText}>
