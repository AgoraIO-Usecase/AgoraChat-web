...
import memberInfoIcon from "../../../../assets/person_3lines_fill.png";
...
const GroupSettingsDialog = ({ open, onClose, currentGroupId, authorEl }) => {
  ...
  const renderSetting = () => {
    const memberLabel = () => {
      return (
        <Button className={classes.membersBox}>
          <img src={membersIcon} alt="members" className={classes.iconStyle} />
          <Typography className={classes.menus}>
            {i18next.t("Members")}
            <span style={{ color: "#ccc", marginLeft: "5px" }}>
              ({groupsInfo.affiliations_count})
            </span>
          </Typography>
        </Button>
      );
    ...
    const notificationsLabel = () => {
      return (
        <Button className={classes.membersBox}>
          <img src={muteIcon} alt="files" className={classes.iconStyle}></img>
          <Typography className={classes.menus}>
    ...
    const groupFileLabel = () => {
      return (
        <Button className={classes.membersBox}>
          <img src={filesIcon} alt="files" className={classes.iconStyle}></img>
          <Typography className={classes.menus}>Group File</Typography>
        </Button>
      );
    };
    // const groupFileLabel = () => {
    ...
    const GroupMemberInfoLabel = () => {
      return (
        <Button className={classes.membersBox}>
          <img
            src={memberInfoIcon}
            alt="Modify Group Info"
            className={classes.iconStyle}
          ></img>
          <Typography className={classes.menus}>
      ...
      <Box className={classes.root}>
        ...
        <Box className={classes.gSettingRight}>
          ...
          <TabPanel value={value} index={3} className={classes.content}>
            <Notifications
              showMuteImgOrNot={showMuteImgOrNot}
              groupId={groupId}
              useScene="groupChat"
              useComponent="Group"
            />
