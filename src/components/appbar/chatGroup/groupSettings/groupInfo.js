...
const GroupInfo = () => {
    ...
    return (
        <Box className={classes.root}>
            ...
            >
                <Tab label={i18next.t('All')} {...a11yProps(0)} className={classes.menus} />
                <Tab label={i18next.t('Admin')} {...a11yProps(1)} className={classes.menus} />
                {isAdmins && <Tab label={i18next.t('Muted')} {...a11yProps(2)} className={classes.menus} />}
                {isAdmins && <Tab label={i18next.t('Blocked')} {...a11yProps(3)} className={classes.menus} />}
                {isAdmins && <Tab label={i18next.t('Allowed')} {...a11yProps(4)} className={classes.menus} />}
            </Tabs>
