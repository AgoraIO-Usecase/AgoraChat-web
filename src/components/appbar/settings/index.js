...
const useStyles = makeStyles((theme) => {
  return {
    ...
    selectBottom: {
      ...
      background: "#F4F5F7",
      boxShadow:
        "0px 24px 36px rgba(0, 0, 0, 0.2), 8px 0px 24px rgba(0, 0, 0, 0.16)",
      borderRadius: "12px",
      ...
      <div className={classes.infoPanel} style={{ display: "block" }}>
        {editStatus ? (
          <Box className={classes.infoSwitchItem}>
            ...
            />
            <span className={classes.doneNickName} onClick={submitNickName}>
              Done
            </span>
          </Box>
        ) : (
  ...
  function aboutTabPanel() {
    return (
      <div className={classes.infoPanel}>
        <div style={{ flex: 1 }}>
          <div className={classes.aboutItem}>SDK Version: 1.3.0</div>
          <div className={classes.aboutItem}>UIKit Version: 1.3.0</div>
  ...
  function privacyTabPanel() {
    return (
      <div className={classes.infoPanel}>
        ...
        {showOrClose && (
          <List dense className={classes.listBoxBlock} sx={{ width: "400px" }}>
            {blockList.length ? (
              blockList.map((value) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <IconButton
                        value={value}
                        onClick={handlePrivacyItemMoreClick}
                      >
                        <MoreVertIcon />
                      </IconButton>
                    </Button>
  ...
  function renderTurnOffContent() {
    return (
      <div className={classes.contentBox}>
        {defaultValue === "5" ? (
          "You have set Do Not Disturb."
        ) : (
          <span>
            You have set Do Not Disturb{" "}
            <span className={classes.unmuteTimeStyle}>{checkedValue}</span>.
          </span>
        )}
      </div>
    );
  ...
  function renderTurnOffFooter() {
    return (
      <div className={classes.btnBox}>
        <span className={classes.turnOffBtnStyle} onClick={handleTurnOffClose}>
          Cancel
        </span>
        <span className={classes.rightBtn} onClick={handlerOkay}>
          Okay
        </span>
      </div>
    );
              ...
              <div className={classes.bottomItem}>
                ...
                >
                  ...
                  {checkedValue && turnOffBtnFlag ? (
                    <span
                      onClick={(e) => handlerTurnOffBtn(e)}
                      className={classes.turnStyle}
                    >
                      Turn Off
                    </span>
                  ) : (
                ...
                {showRadio ? (
                  <div
                    className={classes.previewStyle + " " + classes.bottomItem}
                  >
                    <RadioGroup
